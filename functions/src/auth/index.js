 ...
 */
export const signInWithPassword = functions.https.onRequest((req, res) => {
 ...
 */
export const signOut = functions.https.onRequest((req, res) => {
  corsHandler(req, res, async () => {
    try {
      // Vérifier la méthode HTTP
      if (req.method !== 'POST') {
 ...
 */
export const addLog = functions.https.onRequest((req, res) => {
  corsHandler(req, res, async () => {
    try {
      // Vérifier la méthode HTTP
      if (req.method !== 'POST') {
